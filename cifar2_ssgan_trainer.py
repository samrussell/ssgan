...
class CifarSsganTrainer(base_trainer.BaseTrainer):
  ...
  def build_models(self, input_shape):
    ...
    self.discriminator.add(Conv2D(96, (3, 3), padding = 'same', activation='relu', input_shape=input_shape))
    self.discriminator.add(Conv2D(96, (3, 3), padding = 'same', activation='relu'))
    self.discriminator.add(Conv2D(96, (3, 3), strides=(2, 2), padding = 'same', activation='relu'))
    self.discriminator.add(Dropout(0.2))
    self.discriminator.add(Conv2D(192, (3, 3), padding = 'same', activation='relu'))
    self.discriminator.add(Conv2D(192, (3, 3), padding = 'same', activation='relu'))
    self.discriminator.add(Conv2D(192, (3, 3), strides=(2, 2), padding = 'same', activation='relu'))
    self.discriminator.add(Dropout(0.2))
    self.discriminator.add(Conv2D(192, (3, 3), padding = 'same', activation='relu'))
    self.discriminator.add(Conv2D(192, (1, 1), padding = 'same', activation='relu'))
    ...
    self.generator.add(Conv2D(192, (1, 1), padding='same', activation='relu'))
    self.generator.add(Conv2D(192, (3, 3), padding='same', activation='relu'))
    ...
    self.generator.add(UpSampling2D(size=(2, 2)))
    self.generator.add(Dropout(0.2))
    self.generator.add(Conv2D(96, (3, 3), padding='same', activation='relu'))
    self.generator.add(Conv2D(96, (3, 3), padding='same', activation='relu'))
    self.generator.add(Conv2D(96, (3, 3), padding='same', activation='relu'))
    self.generator.add(Conv2D(3, (3, 3), padding='same', activation='relu'))
